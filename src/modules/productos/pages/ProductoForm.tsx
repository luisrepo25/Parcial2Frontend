...
import { categoriaApi } from "../../categoria/services/categoriaApi";
import { marcaApi } from "../../Marca/services/marcaApi";
import { garantiaApi } from "../../garantia/services/garantiaApi";
...
import { FaSave, FaTimes, FaBoxOpen } from "react-icons/fa";
...
const ProductoForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Preparar datos para enviar - asegurar que precio y stock sean números
      const dataToSend = {
